export const giftsMapping = [
  ...
  },
  {
    ...
    cost: "500USD",
    image: process.env.PUBLIC_URL + "assets/Gifts/2.jpg",
  },
  {
    id: 3,
    name: "Hotel night in Auckland",
    description:
  ...
  },
  {
    ...
    cost: "70USD epr person (120USD for fanny and nate)",
  ...
  {
    id: 10,
    name: "Bottle of wine from the Marborough wine region",
    description:
      "Buy us a bottle of wine from one of the many wineries in the Marborough wine region. The Marlborough wine region is by far New Zealand's largest, accounting for three quarters of the country's wine production, 70% of its vineyard area and 85% of its wine exports. Internationally, Marlborough Sauvignon Blanc is recognised as world class",
    cost: "20USD for one wine bottle",
    image: process.env.PUBLIC_URL + "assets/Gifts/10.jpg",
  },
  {
    id: 11,
    name: "Kaikoura whale watching",
    description:
      "Experience the natural treasures of New Zealand on a Kaikoura whale-watching cruise. Look for impressive sperm whales along with migrating humpbacks and southern right whales, and search the waters for orcas and other dolphins as an experienced guide shares informative commentary",
    cost: "200USD for Fanny and Nate",
    image: process.env.PUBLIC_URL + "assets/Gifts/11.jpg",
  },
  {
    id: 12,
    name: "Christchurch gondola",
    description:
      "An unmissable Christchurch experience, the Gondola offers stunning panoramic views of the city, Lyttelton Harbour, and beyond. Gaze at the snow-capped Southern Alps, sprawling Canterbury Plains and the sparkling waters of Pegasus Bay and the Pacific Ocean. A great spot to explore.",
    cost: "46USD for Fanny and Nate",
    image: process.env.PUBLIC_URL + "assets/Gifts/12.jpg",
  },
  {
    id: 13,
    ...
    image: process.env.PUBLIC_URL + "assets/Gifts/13.jpg",
  },
  {
    id: 14,
    name: "Milford sound cruise and Kayaking",
    description:
