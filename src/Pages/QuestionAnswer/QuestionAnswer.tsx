...
const faqData = [
  ...
  { question: "Where should I stay in Stockholm", answer: "For the people coming from America, we have made reservations at Scandic Hotel Continental in Central Stockholm for a cheaper rate. If you are interested, please let us know in the the RSVP."},
