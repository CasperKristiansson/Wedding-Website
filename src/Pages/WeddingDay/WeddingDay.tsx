      ...
      >
        ...
        >
          ...
          <p>
            ...
            Sånga Prästgårds Väg 1, 179 96 Svartsjö, SWEDEN
            <a
        ...
        >
          ...
          <p>
          After the ceremony we will head to the reception at Ekebyhovs Slott. There we will celebrate, eat delicious food, dance and party all night Björkuddsvägen 107, 178 34 Ekerö, Sweden
            <a
              className={classes.googleMapsLink}
        ...
        >
          ...
          <p>
            The day after the wedding we will have Swedish Fika (food and drinks) at Kristiansson’s home for those who are able to attend. Fanny and Nathaniel will open the wedding gifts that you all got them Glädjevägen 29, 16575 Hässelby, Sweden
            <a
              className={classes.googleMapsLink}
